...
Procedure Persona (var FP : TFP);
          ...
          begin
               ...
               readln(Fullname);
               writeln('Ingrese tu edad: ');
               readln(age);
               writeln('Ingrese motivo de visita: ');
               readln(Medical_Consultation);
               reset(FP);
               writeln(Fullname,' tiene ', age, ' anios de edad, ','su consulta se debe a: ', Medical_Consultation);
               readln(Fullname,age, Medical_Consultation);
...
procedure Alimentos (var FA : TFA);  //procesos para ingresar los datos del paciente en peso y altura, para calcular el grado.
         ...
         begin
             ...
             if not eof(FA) then begin
                ...
                //persona(FP);
               // read(Fullname, age, Medical_Consultation);
	             close(FA);
	             readkey;
          end;
...
begin
   repeat
         ...
         writeln ('3. Registro de paciente ');
		 writeln;
		 writeln ('0. Salir ');
		 key:=validar();
		 case key of
